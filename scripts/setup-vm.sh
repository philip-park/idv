...
#  str+=( "-display gtk,gl=on \\" )
  ...
  ports=( 5550 5551 5552 5553 5554 5555 5556 5557 5558 5559 )
  port_num=${low_vgpu: -1}
  str+=( "-vnc :$port_num \\" )
  ...
  p_idx=$((($port_num - 1) * 2))
  str+=( "-device e1000,netdev=net0 -netdev user,id=net0,hostfwd=tcp::${ports[$p_idx]}-:${ports[$p_idx]},hostfwd=tcp::${ports[$((p_idx+1))]}-:${ports[$((p_idx+1))]} \\" )
